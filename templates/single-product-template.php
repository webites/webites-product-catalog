...
<?php $image = get_option('wbcp_display_display_image'); ?>
        ...
        ?>
            ...
            <?php if($colors) {
                ...
                ?> <div class="post-meta-box meta-colours">
                    <h2><?php _e( "Colors", 'wb-product-catalog') ?></h2>
            ...
            ?> <div class="post-meta-box meta-dimensions">
                <h2><?php _e( "Dimensions", 'wb-product-catalog') ?></h2>
            ...
            ?> <div class="post-meta-box meta-sku">
                <h2><?php _e( "SKU", 'wb-product-catalog') ?></h2>
            ...
            ?> <div class="post-meta-box meta-series">
                <h2><?php _e( "Series", 'wb-product-catalog') ?></h2>
            ...
            <?php if($type) {
                ...
                ?> <div class="post-meta-box meta-type">
                    <h2><?php _e( "Type", 'wb-product-catalog') ?></h2>
            ...
            ?> <div class="post-meta-box meta-price">
                <h2><?php _e( "Price", 'wb-product-catalog') ?></h2>
